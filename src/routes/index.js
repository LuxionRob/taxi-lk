...
function route(app) {
  app.use(function (req, res, next) {
    res.setHeader(
      ...
      "script-src 'unsafe-eval' 'unsafe-inline' https://tagmanager.google.com/ https://www.googletagmanager.com/ https://maps.googleapis.com https://doitaxilongkhanh.com https://static.hotjar.com https://script.hotjar.com;"
    )
    next()
  })
  controller
